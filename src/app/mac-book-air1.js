...
const MacBookAir1 = () => {
  ...
  const [iconActionPlasItems] = useState([
    {
      ...
      endIcon: false,
      startIcon: false,
      iconActionPlasHeight: "2rem",
      iconActionPlasFlex: "unset",
      variant1: "right",
      showArrow: false,
      arrowHeight: "",
      arrowWidth: "",
  ...
  return (
    <div className="w-full h-[278.5rem] relative bg-color-gray-0 overflow-hidden flex flex-col items-start pt-[0rem] px-[0rem] pb-[12.25rem] box-border gap-[2.625rem] leading-[normal] tracking-[normal] mq750:gap-[1.313rem] mq1050:h-auto">
      <div className="mt-[-18.188rem] ml-[-52rem] mb-[9.312rem] w-[7.5rem] h-[6.25rem] relative bg-[#d9d9d9] shrink-0" />
      <MainContentArea />
      <main className="self-stretch flex items-start pt-[0rem] px-[0rem] pb-[3.693rem] box-border max-w-full shrink-0 text-left text-[3rem] text-color-gray-0 font-[Pretendard] mq750:pb-[1.25rem] mq750:box-border mq1225:pb-[1.563rem] mq1225:box-border">
        <div className="flex-1 flex items-start relative isolate max-w-full">
          ...
          <div className="flex-1 flex flex-col items-center gap-[3.062rem] max-w-full z-[1] text-[1.25rem] text-color-gray-500 mq750:gap-[1.5rem]">
            <div className="self-stretch h-[3.5rem] bg-color-gray-100 overflow-hidden shrink-0 flex items-start py-[1rem] pl-[1.25rem] pr-[1.187rem] box-border mq1225:h-auto">
              <div className="flex items-center gap-[1.125rem] mq1225:flex-wrap">
                <h3 className="m-0 relative text-[length:inherit] leading-[120%] font-bold font-[inherit] mq450:text-[1rem] mq450:leading-[1.188rem]">
                  #퍼블리싱_가능
                </h3>
                <h3 className="m-0 relative text-[length:inherit] leading-[120%] font-bold font-[inherit] mq450:text-[1rem] mq450:leading-[1.188rem]">
                  #개발자_협업다수
            ...
            <div className="self-stretch flex flex-col items-start py-[0rem] px-[2.25rem] box-border gap-[3rem] max-w-full text-[3rem] text-color-primary-400 font-['BR_B'] mq750:gap-[1.5rem]">
              <div className="self-stretch flex flex-col items-center gap-[3rem] max-w-full mq750:gap-[1.5rem]">
                ...
                <div className="self-stretch flex flex-col items-center justify-center py-[0rem] px-[5rem] box-border gap-[2rem] max-w-full mq750:gap-[1rem] mq1225:pl-[2.5rem] mq1225:pr-[2.5rem] mq1225:box-border">
                  <section className="w-[65.5rem] flex items-center gap-[1.437rem] max-w-full text-left text-[4rem] text-[#000] font-[Pretendard]">
                    <div className="h-[21rem] w-[24.188rem] flex flex-col items-start gap-[0.75rem] mq750:h-auto">
                      <Image
                        ...
                        src="/Group-30@2x.png"
                      />
                      <div className="self-stretch flex items-center justify-between gap-[1.05rem] mq750:flex-wrap mq750:gap-[1.05rem]">
                        <div className="h-[4rem] w-[4rem] rounded-radius-md bg-[#000] overflow-hidden shrink-0 flex items-center justify-center">
                          <Image
                            className="h-[2.519rem] w-full relative"
                            loading="lazy"
                            width={26.8}
                            height={40.3}
                            sizes="100vw"
                        ...
                        <div className="h-[4rem] w-[4rem] rounded-radius-md bg-color-gray-0 border-color-gray-400 border-solid border-[1px] box-border overflow-hidden shrink-0 flex items-center justify-center">
                          <Image
                            className="h-[2.5rem] w-full relative object-cover"
                            loading="lazy"
                            width={40}
                            height={40}
                            sizes="100vw"
                        ...
                        <Image
                          className="w-[4rem] rounded-radius-md max-h-full object-cover"
                          loading="lazy"
                          width={64}
                          height={64}
                          sizes="100vw"
                          alt=""
                          src="/Tool-Icon-Items@2x.png"
                        />
                        <Image
                          className="w-[4rem] rounded-radius-md max-h-full object-cover"
                          loading="lazy"
                    ...
                    <div className="flex-1 flex flex-col items-start gap-[1.5rem] max-w-full">
                      <div className="self-stretch flex items-center justify-between gap-[1.25rem] max-w-full mq750:flex-wrap mq750:gap-[1.25rem]">
                      ...
                      <div className="self-stretch flex flex-col items-start gap-[0.75rem] text-[1.25rem]">
                        <b className="self-stretch relative leading-[120%] mq450:text-[1rem] mq450:leading-[1.188rem]">
                          <span className="leading-[120%]">{`프론트엔드 이해도를 바탕으로 개발자와 소통하며,기획부터 일러스트까지.<br/>실전에 바로 투입 가능한 `}</span>
                          <span className="text-[#498adf] leading-[120%]">
                            프로덕트 디자이너 최하은
                          </span>
                          <span className="leading-[120%]">입니다.</span>
                        </b>
                        <div className="self-stretch relative text-[1rem] leading-[150%] text-color-gray-700">
                          <span className="leading-[150%]">{`제품을 처음 마주한 사용자가 헤매는 순간은 곧 `}</span>
                          <span className="font-semibold leading-[150%]">
                            UX의 실패
                          </span>
                          <span className="leading-[150%]">{`라고 믿기에, '백지상태'의 `}</span>
                          <span className="font-semibold leading-[150%]">
                            사용자 시선에서 인지적 부담을 최소화
                          </span>
                          <span className="leading-[150%]">{`한 직관적인 인터페이스를 설계합니다. 프론트엔드 개발을 공부했던 경험과 퍼블리싱 역량을 바탕으로 시스템 구조를 깊이 이해하며, `}</span>
                          <span className="font-semibold leading-[150%]">
                            개발 팀과 완벽하게 소통
                          </span>
                          <span className="leading-[150%]">{`합니다. 12개 이상의 실무형 프로젝트를 주도하며 복잡한 `}</span>
                          <span className="font-semibold leading-[150%]">
              ...
              <div className="self-stretch flex flex-col items-center gap-[3rem] mq750:gap-[1.5rem]">
                ...
                <div className="self-stretch flex flex-col items-center justify-center py-[0rem] px-[5rem] gap-[3.5rem] mq750:gap-[1.75rem] mq1225:pl-[2.5rem] mq1225:pr-[2.5rem] mq1225:box-border">
                  <div className="self-stretch grid grid-cols-[repeat(auto-fit,_minmax(342px,_1fr))] [align-content:start] [column-gap:24px] [row-gap:56px]">
                    <section className="flex flex-col items-start gap-[1.5rem] col-[1] row-[1] text-left text-[3rem] text-[#d19e34] font-[Pretendard]">
                      <div className="self-stretch flex flex-col items-start gap-[0.5rem]">
                        <div className="flex items-end gap-[0.375rem] mq450:flex-wrap">
                          <h2 className="m-0 relative text-[length:inherit] leading-[120%] font-semibold font-[inherit] mq450:text-[1.813rem] mq450:leading-[2.188rem] mq750:text-[2.375rem] mq750:leading-[2.875rem]">
                            hear
                          </h2>
                          <div className="relative text-[0.875rem] leading-[150%] text-color-gray-500">
                            2026.06.12~2026.7.1
                          </div>
                        </div>
                        <b className="self-stretch relative text-[1.25rem] leading-[120%] text-[#000] mq450:text-[1rem] mq450:leading-[1.188rem]">
                          털어놓으면 일기가 되고,
                          <br />
                          쌓이면 내 마음이 보이는 AI 감정 기록 서비스
                        </b>
                      </div>
                      <div className="self-stretch flex flex-col items-start gap-[1rem] text-[1rem] text-[#eebc52]">
                        <Image
                          className="self-stretch shadow-[0px_0px_5px_rgba(0,_0,_0,_0.15)] max-w-full overflow-hidden max-h-full object-cover"
                          loading="lazy"
                          width={512}
                          height={287.4}
                          sizes="100vw"
                          alt=""
                          src="/Details-Padding@2x.png"
                        />
                        <div className="self-stretch flex items-center gap-[0.5rem] mq750:flex-wrap">
                          <div className="flex items-center gap-[0.25rem]">
                            ...
                            <div className="relative leading-[150%] text-color-gray-600">
                              기여도
                            </div>
                          </div>
                    ...
                    <section className="flex flex-col items-start gap-[1.5rem] col-[2] row-[1] text-left text-[3rem] text-[#d19e34] font-[Pretendard]">
                      <div className="self-stretch flex flex-col items-start gap-[0.5rem]">
                        <div className="flex items-end gap-[0.375rem] mq450:flex-wrap">
                          <h2 className="m-0 relative text-[length:inherit] leading-[120%] font-semibold font-[inherit] mq450:text-[1.813rem] mq450:leading-[2.188rem] mq750:text-[2.375rem] mq750:leading-[2.875rem]">
                            hear
                    ...
                    <section className="flex flex-col items-start gap-[1.5rem] col-[1] row-[2] text-left text-[3rem] text-[#d19e34] font-[Pretendard]">
                      <div className="self-stretch flex flex-col items-start gap-[0.5rem]">
                        <div className="flex items-end gap-[0.375rem] mq450:flex-wrap">
                          <h2 className="m-0 relative text-[length:inherit] leading-[120%] font-semibold font-[inherit] mq450:text-[1.813rem] mq450:leading-[2.188rem] mq750:text-[2.375rem] mq750:leading-[2.875rem]">
                            hear
                    ...
                    <section className="flex flex-col items-start gap-[1.5rem] col-[2] row-[2] text-left text-[3rem] text-[#d19e34] font-[Pretendard]">
                      <div className="self-stretch flex flex-col items-start gap-[0.5rem]">
                        <div className="flex items-end gap-[0.375rem] mq450:flex-wrap">
                          <h2 className="m-0 relative text-[length:inherit] leading-[120%] font-semibold font-[inherit] mq450:text-[1.813rem] mq450:leading-[2.188rem] mq750:text-[2.375rem] mq750:leading-[2.875rem]">
                            hear
              ...
              <div className="self-stretch flex flex-col items-center gap-[3rem] mq750:gap-[1.5rem]">
                <div className="self-stretch h-[3.625rem] flex items-center gap-[1rem]">
                  <h2 className="m-0 relative text-[length:inherit] leading-[120%] font-normal font-[inherit]">
                    Blog
                  </h2>
                  <div className="h-[0.063rem] flex-1 relative border-color-gray-400 border-solid border-t-[1px] box-border" />
                </div>
                <div className="self-stretch flex flex-col items-start py-[0rem] px-[5rem] mq1225:pl-[2.5rem] mq1225:pr-[2.5rem] mq1225:box-border">
                  <div className="self-stretch rounded-xl bg-color-gray-100 flex flex-col items-center py-[2.25rem] px-[1.5rem] gap-[2rem] mq750:gap-[1rem] mq750:pt-[1.438rem] mq750:pb-[1.438rem] mq750:box-border">
                      ...
                      <div className="flex-1 flex items-center justify-center gap-[1.5rem] min-w-[35.563rem] mq1050:flex-wrap mq1050:min-w-full">
                        {frameComponent1Items.map((item, index) => (
                          <FrameComponent1
                            ...
                            chipVariant1={item.chipVariant1}
                            chipProp={item.chipProp}
                            chipProp1={item.chipProp1}
                            chipBorder={item.chipBorder}
                            chipBorder1={item.chipBorder1}
                            chipHeight={item.chipHeight}
                            chipHeight1={item.chipHeight1}
                          />
                        ))}
                      </div>
                      <Arrow
